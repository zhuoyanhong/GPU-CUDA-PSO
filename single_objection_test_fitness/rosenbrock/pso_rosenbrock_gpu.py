...
for step in range(iter_num):
    ...
    fun_flush_zeros(x_cur_one_gpu, grid=grids, block=(n, 1, 1))
    fun_flush_zeros(x_one_gpu, grid=grids, block=(n, 1, 1))
    fun_flush_zeros(x_two_gpu, grid=grids, block=(n, 1, 1))
    fun_flush_zeros(x_cur_gpu, grid=grids, block=(n, 1, 1))
